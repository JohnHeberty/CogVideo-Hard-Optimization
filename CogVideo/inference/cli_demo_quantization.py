...
def generate_video(
    ...
    # Apply conditional offload strategy based on VRAM
    log_vram_status("[Before Quantized Pipeline Load] ")
    ...
    log_vram_status("[After Quantized Pipeline Load] ")
    ...
    # Auto-detect FPS if not explicitly set
    if fps == 8:  # Default value, use auto-detection
